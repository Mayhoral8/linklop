...
const [btnText, setBtnText] = useState('copy')
  const {modal, setModal, modalMsg, qrCode} = useContext(ContextCreate)
  useEffect(() => {
  ...
  if(modal){
    ...
    return (<>
                ...
                <ModalStyle>
                  <div className='w-64 h-72 bg-white border-2 grid grid-rows-4 rounded-md justify-space-evenly border-blue-500 ' data-aos-easing="ease-in"
