    ...
    <>
      <ConsumerContext>
        {(value) => {
          ...
          return (
            <section className="lg:flex lg:justify-evenly lg:flex-row top-0 fixed h-12 lg:h-14 z-10 bg-white w-full shadow-md">
              ...
              <div
              className={`h-0 lg:mt-3 mt-3 lg:flex lg:pl-20 lg:justify-end navbar-project lg:visible sticky transition-all ease-in delay-400 ${
                show ? "h-0" : "h-48 lg:h-0"
              } bg-orange-base w-full  top-0 z-20 absolute block`}
              >
                <div className={` ${show ? "hidden" : "block"} lg:flex lg:justify-around lg:w-96 lg:ml-64 text-center`}>
