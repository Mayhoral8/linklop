...
const Home = () => {
  ...
  <ConsumerContext>
            ...
            <section className="lg:flex lg:flex-row-reverse mt-8 w-96 lg:w-full">
              <div
                className="lg:mt-6 lg:mx-52 mx-auto lg:w-72 lg:h-86 w-44 h-56 "
                data-aos="fade-left"
              ...
              <div className="lg:mt-4  lg:ml-36 flex flex-col mx-auto  
              "
              data-aos="fade-right"
                  data-aos-easing="ease-out"
                  data-aos-duration="1200">
                <h3
                  className="lg:text-5xl text-4xl font-bold text-gray-800 mt-4 text-center lg:text-left"
                ...
                <Link to='/login'>
                <button className="block bg-orange-500 text-white w-44 mt-8 rounded-lg h-10 mx-auto lg:mx-0" onClick={()=> topScroll()}>
